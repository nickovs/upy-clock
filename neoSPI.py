# Implement neopixel protocol on an SPI bus
...
# and 2 of each byte with the top bits all set and the bottom bits all
# clear. 0b00011011 -> 0b10001000 0b10001100 0b11001000 0b11001100
